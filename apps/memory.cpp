...
// Explanation: it doesn't use referencing so it swaps a & b which are new variables local to swap3 
               //but doesn't touch the original variables i & j so their values remain unchanged.
void swap3(double a, double b)
{
    double temp_a = a;
    a = b;
